            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/admin/create_assessment" class="btn btn-primary mb-3">Create New Assessment</a>
                        <a href="/admin/export_assessment_results" class="btn btn-success mb-3 ml-2">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/admin/delete_assessment/<?php echo $assessment['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this assessment?');">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
function viewResults(assessmentId) {
    fetch(`/admin/get_assessment_results/${assessmentId}`)
