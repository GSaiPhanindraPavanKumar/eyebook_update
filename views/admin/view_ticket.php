            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Student Information -->
                        <div class="student-info bg-light p-3 rounded mb-4">
                            <h6 class="font-weight-bold">Student Information</h6>
                            <div class="row">
                                <div class="col-md-4">
                                    <p class="mb-1"><strong>Name:</strong> <?php echo htmlspecialchars($ticket['student_name']); ?></p>
                                </div>
                                <div class="col-md-4">
                                    <p class="mb-1"><strong>University:</strong> <?php echo htmlspecialchars($ticket['university_name']); ?></p>
                                </div>
                                <div class="col-md-4">
                                    <p class="mb-1"><strong>College:</strong> <?php echo htmlspecialchars($ticket['college_name']); ?></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($ticket['status'] === 'active'): ?>
                            <div class="reply-form mt-4">
                                <form id="replyForm" method="POST" action="/admin/add_ticket_reply">
...
<style>
/* Include the same styles as in the student view_ticket.php */
.ticket-content {
