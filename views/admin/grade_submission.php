        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="/admin/view_assignment/<?php echo $assignment['id']; ?>" class="btn btn-secondary">Back to Assignment</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <form action="/admin/grade_submission/<?php echo $assignment['id']; ?>/<?php echo $student_submission['student_id']; ?>" method="post" style="margin-top: 20px;">
