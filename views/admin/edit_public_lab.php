    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card"><br>
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="/admin/edit_public_lab/<?php echo $lab['id']; ?>">
                            ...
                            <a href="/admin/view_labs_by_public_course/<?php echo $course_ids[0]; ?>" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
