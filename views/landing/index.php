...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="/views/public/landing/assets/img/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/views/public/landing/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/views/public/landing/assets/img/favicons/favicon-16x16.png">
    <link rel="shortcut icon" type="image/x-icon" href="/views/public/landing/assets/img/favicons/favicon.ico">
    <link rel="manifest" href="/views/public/landing/assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="/views/public/landing/assets/img/favicons/mstile-150x150.png">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="/views/public/landing/assets/css/theme.css" rel="stylesheet" />
