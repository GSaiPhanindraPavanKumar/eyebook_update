...
$sql1 = "SELECT COUNT(*) as student_count FROM students WHERE university_id = :university_id";
$stmt1 = $conn->prepare($sql1);
$stmt1->execute(['university_id' => $university_id]);
...
$stmt4 = $conn->prepare($sql_spoc);
$stmt4->execute();
$spocs = $stmt4->fetchAll(PDO::FETCH_ASSOC);

$sql_universities = "SELECT * FROM universities";
$stmt5 = $conn->prepare($sql_universities);
$stmt5->execute();
$universities = $stmt5->fetchAll(PDO::FETCH_ASSOC);

$sql_courses = "SELECT * FROM courses";
$stmt6 = $conn->prepare($sql_courses);
$stmt6->execute();
$courses = $stmt6->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                <p class="mb-4">Total Faculties</p>
                                <p class="fs-30 mb-2"><?php echo $faculty_count; ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
