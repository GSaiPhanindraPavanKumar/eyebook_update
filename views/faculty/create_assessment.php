...
<body class="bg-gray-100">
    <div class="container mx-auto p-4">
        ...
        <div class="mb-4">
            ...
            <a href="create_assessment.php" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Create Assessment</a>
            <a href="manage_assessments.php" class="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600">Manage Assessments</a>
        </div>

        <!-- Create Assessment Form -->
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold mb-4">Create Assessment</h2>
            <form id="assessmentForm" method="POST" action="create_assessment.php">
                <div class="mb-4">
    ...
    $(document).ready(function() {
        ...
        $('#generateQuestions').click(function() {
            ...
            $.ajax({
                url: '/faculty/generate_questions', // Ensure this path matches your routing configuration
                method: 'POST',
                data: {
                    topic: topic,
