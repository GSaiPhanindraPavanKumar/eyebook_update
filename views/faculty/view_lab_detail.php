        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="/faculty/download_lab_report/<?php echo $lab['id']; ?>" class="btn btn-success">Download Report</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><strong>Due Date:</strong> <?php echo htmlspecialchars($lab['due_date']); ?></p>
